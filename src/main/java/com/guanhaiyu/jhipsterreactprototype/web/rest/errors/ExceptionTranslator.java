package com.guanhaiyu.jhipsterreactprototype.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.guanhaiyu.jhipsterreactprototype.service.UsernameAlreadyUsedException
        ) return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
        if (
            ex instanceof com.guanhaiyu.jhipsterreactprototype.service.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof com.guanhaiyu.jhipsterreactprototype.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return Strings.CS.containsAny(
            ...
            "io.",
            "de.",
            "com.guanhaiyu.jhipsterreactprototype"
        );
    }
}
